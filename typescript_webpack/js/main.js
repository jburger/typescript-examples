...
/***/ function(module, exports, __webpack_require__) {
	...
	var Program = (function () {
	    function Program(config, endpoint) {
	        this._config = config;
	        this._endpoint = endpoint;
	    }
	    Program.prototype.Run = function () {
	        $('#welcome-message').text(this._config.welcomeMessage);
	        var response = this._endpoint.Get();
	        throw new Error('boo');
	...
	//todo: DI
	var config = new configuration_1.DevelopmentConfig();
	var service = new services_1.EndpointService(config);
	var app = new Program(config, service);
...
/***/ function(module, exports) {
	...
	var DevelopmentConfig = (function () {
	    function DevelopmentConfig() {
	        this.serviceUrl = "http://tempuri.org/api";
...
/***/ function(module, exports) {
	...
	var EndpointService = (function () {
	    function EndpointService(config) {
	        this._config = config;
	    }
	    EndpointService.prototype.Get = function () {
	        return {
	            data: { 'foo': 'bar' },
	            total: 1
	        };
